...
{
	public static final String CONFIG_TEST  = "src/test/java/config_test.txt";
	
	private static final String CONFIG_GET_ALL_ORDNER = "src/test/java/config_test_GetAllOrdner.txt";
	
	private static final String CONFIG_CREATE_ORDNER = "src/test/java/config_test_CreateOrdner.txt";
	
	private static final String CONFIG_DELETE_ORDNER = "src/test/java/config_test_DeleteOrdner.txt";
	
	private static final String CONFIG_DELETE_FILES = "src/test/java/config_test_DeleteFiles.txt";
	
	private static final String CONFIG_UPDATE_ORDNER = "src/test/java/config_test_UpdateOrdner.txt";
